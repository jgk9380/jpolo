...
public class JSFUtils {
    ...
    public static void refresh(String compentId) {
        UIComponent uc = JSFUtils.findComponentInRoot(compentId);
        if (uc != null)
            AdfFacesContext.getCurrentInstance().addPartialTarget(uc);
        else {
            //addFacesInformationMessage("找不到组件：" + compentId);
            Logger logger = Logger.getLogger(JSFUtils.class);
            logger.warn("找不到组件：" + compentId);
        }
    }
    ...
    public static void showPopup(String id) {
        ...
        AdfFacesContext.getCurrentInstance().addPartialTarget(JSFUtils.findComponentInRoot(id));
        ((RichPopup) JSFUtils.findComponentInRoot(id)).show(ph);
    ...
    public static void hidePopup(String id) {
        RichPopup.PopupHints ph = new RichPopup.PopupHints();
        AdfFacesContext.getCurrentInstance().addPartialTarget(JSFUtils.findComponentInRoot(id));
        ((RichPopup) JSFUtils.findComponentInRoot(id)).hide();
